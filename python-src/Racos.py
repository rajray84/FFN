...
class RacosOptimization:
    ...
    def __init__(self, dim, netPath, inDtype, inShape, inSpecs, tgt, otype):
        ...
        self.__netModel = netPath #FFN
        self.__inpDtype = inDtype #FFN
        self.__inpShape = inShape #FFN
        self.__inpSpecs = inSpecs #FFN
        self.__target = tgt #FFN
        self.__objType = otype #FFN
